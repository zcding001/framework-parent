...
public class RedisClusterPipeline extends PipelineBase implements Closeable {
    ...
    /**
    *  RedisClusterPipeline创建RedisClusterPipeline实例
    *  @param jedisCluster 集群实例
    *  @return RedisClusterPipeline
    *  @since                   ：2019/1/27
    *  @author                  ：zc.ding@foxmail.com
    */
    public static RedisClusterPipeline pipeline(JedisCluster jedisCluster) {
